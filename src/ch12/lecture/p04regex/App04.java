...
public class App04 {
    public static void main(String[] args) {
        ...
        System.out.println(Pattern.matches("\\w{2,4}", "9"));
        System.out.println(Pattern.matches("\\w{2,4}", "965466"));

        //{n} : 정확히 n 개
        //{n,}:n개 이상
        System.out.println(Pattern.matches("\\w{2}", "9c"));
        System.out.println(Pattern.matches("[가-힣]{3,}", "손흥민"));
        System.out.println(Pattern.matches("[가-힣]{3,}", "이론머스크"));
        System.out.println(Pattern.matches("[가-힣 ]{3,}", "이론 머스크"));
    }
}
